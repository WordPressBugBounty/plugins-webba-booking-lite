    ...
    public function initSettings()
    {
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                "popup" => __("Choose the time format for displaying times.", "webba-booking-lite"),
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                "popup" => __("Choose which day the week starts on.", "webba-booking-lite"),
                "extra" => [
        ...
        wbk_opt()->add_option(
            ...
            "number",
            __("Allow to book only these many days in advance", "webba-booking-lite"),
            "wbk_advanced_booking_rules_section",
            [
                "default" => "0",
...
OLD: When one service is booked, it will automatically lock another one on the same time in the same category, preventing conflicting bookings.',
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                "extra" => [
                    ...
                    "reduce" => __("Reduce count of available spaces", "webba-booking-lite"),
                ],
                "dependency" => [["wbk_appointments_auto_lock", "=", "enabled"]],
                "dependent_value" => [
                    "condition" => ["wbk_appointments_auto_lock", "!=", "enabled"],
        ...
        wbk_opt()->add_option(
            ...
            "checkbox",
            __("Enable Timezone picker in the booking form", "webba-booking-lite"),
            "wbk_advanced_booking_rules_section",
            [
                "not_translated_title" => "Enable Timezone picker in the booking form",
                "popup" => __("Enable timezone picker in the booking form.", "webba-booking-lite"),
                "checkbox_value" => "yes",
                "default" => "yes",
                "tab" => "booking-form",
            ],
        ...
        wbk_opt()->add_option(
            ...
            "checkbox",
            __("Enable Booking Instructions in confirmation step", "webba-booking-lite"),
            "wbk_advanced_booking_rules_section",
            [
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                "dependency" => [["wbk_enable_booking_instructions", "=", "yes"]],
                "tab" => "booking-form",
            ],
        );
        ...
        */
        ...
        wbk_opt()->add_option(
            ...
            "select",
            __("Reminder sending time (for both Email and SMS)", "webba-booking-lite"),
            "wbk_notifications_settings_section",
            [
                "default" => "43200",
                "extra" => $data_time,
...
When Disabled: The \'From email\' value is used as the reply-to address for notifications.',
        ...
        wbk_opt()->add_option(
            ...
            "select",
            __("How many days in advance to send email booking reminder", "webba-booking-lite"),
            "wbk_notifications_settings_section",
            [
                "default" => "1",
        ...
        wbk_opt()->add_option(
            ...
            "number",
            __('Set email delay for booking status "Arrived"', "webba-booking-lite"),
            "wbk_notifications_settings_section",
            [
                "default" => "",
        ...
        wbk_opt()->add_option(
            ...
            "select",
            __("Page used for Payment, Cancelation and Approval links", "webba-booking-lite"),
            "wbk_notifications_settings_section",
            [
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                "popup" => __("Stripe Other button text.", "webba-booking-lite"),
                "tab" => "payments",
            ],
        );
        ...
        $form_fields = WBK_Form_Builder_Utils::get_default_fields();
        foreach ($form_fields as $field) {
            wbk_opt()->add_option(
                ...
                [
                    ...
                    "popup" => __("Text of the form field " . $field["slug"], "webba-booking-lite"),
                    "tab" => "form-fields",
                ],
            );
        }
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                "default" => "7.26.0",
                "extra" => [
                    "7.26.0" => __("Yes, load version 7.26.0", "webba-booking-lite"),
                    "6.21.1" => __("Load version 6.21.1", "webba-booking-lite"),
                    "no" => __("No", "webba-booking-lite"),
                ],
                "required_plan" => "standard",
                "tab" => "stripe",
        ...
        wbk_opt()->add_option(
            ...
            "select",
            __("Admin calendar event creation for connected calendars", "webba-booking-lite"),
            "wbk_integrations_settings_section",
            [
                "default" => "onbooking",
        ...
        wbk_opt()->add_option(
            "wbk_gg_notice",
            "notice",
            __("Google Calendar Integration Documentation ->", "webba-booking-lite"),
            "wbk_integrations_settings_section",
            [
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                "extra" => [
                    "lock" => __("Lock time slot", "webba-booking-lite"),
                    "reduce" => __("Reduce count of available slots", "webba-booking-lite"),
                ],
                "required_plan" => "start",
                "tab" => "google-calendar",
            ],
        ...
        wbk_opt()->add_option(
            ...
            "checkbox",
            __("Keep Legacy Calendars active", "webba-booking-lite"),
            "wbk_integrations_settings_section",
            [
        ...
        */
        ...
        wbk_opt()->add_option(
            "wbk_woo_notice",
            "notice",
            __("WooCommerce Integration Documentation ->", "webba-booking-lite"),
            "wbk_payment_settings_section",
            [
        ...
        wbk_opt()->add_option(
            ...
            "checkbox",
            __("Send SMS after admin adds a booking manually", "webba-booking-lite"),
            "wbk_notifications_settings_section",
            [
                "checkbox_value" => "true",
                "dependency" => [["wbk_sms_send_on_booking", "=", "true"]],
                "dependent_value" => [
                    "condition" => ["wbk_sms_send_on_booking", "!=", "true"],
                    "value" => "",
                ],
        ...
        wbk_opt()->add_option(
            ...
            "wbk_translation_settings_section",
            [
                "default" => __("Make multiple bookings:", "webba-booking-lite"),
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                "popup" => __("Label for the user dashboard link.", "webba-booking-lite"),
                "tab" => "user-dashboard",
            ],
        );
        wbk_opt()->add_option(
            ...
            "text",
            __("Title for bookings section of the User dashboard", "webba-booking-lite"),
            "wbk_translation_settings_section",
            [
        ...
        wbk_opt()->add_option(
            ...
            "text",
            __("Title for previous bookings section of the user dashboard", "webba-booking-lite"),
            "wbk_translation_settings_section",
            [
        ...
        wbk_opt()->add_option(
            ...
            "text",
            __("Title for the reschedule link text in user dashboard", "webba-booking-lite"),
            "wbk_translation_settings_section",
            [
        ...
        wbk_opt()->add_option(
            ...
            "text",
            __("Title for the cancel link text in user dashboard", "webba-booking-lite"),
            "wbk_translation_settings_section",
            [
                "default" => __("Cancel booking", "webba-booking-lite"),
        ...
        wbk_opt()->add_option(
            ...
            "wbk_translation_settings_section",
            [
                "default" => __("Confirm cancellation", "webba-booking-lite"),
                "not_translated_title" =>
                    "Title for the confirm cancellation link text in user dashboard",
                "popup" => __(
        ...
        wbk_opt()->add_option(
            ...
            "wbk_translation_settings_section",
            [
                "default" => __("No bookings available", "webba-booking-lite"),
        ...
        wbk_opt()->add_option(
            ...
            "wbk_translation_settings_section",
            [
                "default" => __("Login to your booking manager", "webba-booking-lite"),
        ...
        wbk_opt()->add_option(
            ...
            "wbk_translation_settings_section",
            [
                "default" => __("Manage your appointments and reservations", "webba-booking-lite"),
                "not_translated_title" => "Manage your appointments and reservations",
                "popup" => __(
                    "Specify the message to display at the top of the manage your appointments and reservations form",
                    "webba-booking-lite",
                ),
                "tab" => "user-dashboard",
            ],
        ...
        wbk_opt()->add_option(
            "wbk_user_dashboard_upcoming_bookings_title",
            "text",
            __("Upcoming bookings title", "webba-booking-lite"),
            "wbk_translation_settings_section",
            [
                "default" => __("Upcoming", "webba-booking-lite"),
                "not_translated_title" => "Upcoming bookings title",
                "popup" => __(
                    "Specify the title for the upcoming bookings section",
                    "webba-booking-lite",
                ),
                "tab" => "user-dashboard",
            ],
        ...
        wbk_opt()->add_option(
            "wbk_user_dashboard_past_bookings_title",
            "text",
            __("Past bookings title", "webba-booking-lite"),
            "wbk_translation_settings_section",
            [
                "default" => __("Past", "webba-booking-lite"),
                "not_translated_title" => "Past bookings title",
                "popup" => __(
                    "Specify the title for the past bookings section",
                    "webba-booking-lite",
                ),
                "tab" => "user-dashboard",
            ],
        ...
        wbk_opt()->add_option(
            "wbk_user_dashboard_new_booking_title",
            "text",
            __("+ New Booking title", "webba-booking-lite"),
            "wbk_translation_settings_section",
            [
                "default" => __("+ New Booking", "webba-booking-lite"),
                "not_translated_title" => "+ New Booking title",
                "popup" => __(
                    "Specify the title for the + New Booking button",
                    "webba-booking-lite",
                ),
                "tab" => "user-dashboard",
            ],
        ...
        */
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                "popup" => __("Error message when no time slot is selected.", "webba-booking-lite"),
                "tab" => "validation",
            ],
        );
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                "popup" => __("Follow-up message shown after booking.", "webba-booking-lite"),
                "tab" => "booking-status",
            ],
        );
        wbk_opt()->add_option(
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                "popup" => __("Label for total amount in payment summary.", "webba-booking-lite"),
                "tab" => "payments",
            ],
        );
        wbk_opt()->add_option(
        ...
        wbk_opt()->add_option(
            ...
            [
                "default" => __("Tax", "webba-booking-lite"),
                "not_translated_title" => "Tax label",
                "popup" => __("Label for tax in payment summary.", "webba-booking-lite"),
                "tab" => "payments",
            ],
        );
        wbk_opt()->add_option(
            ...
            [
                "default" => __("Discount", "webba-booking-lite"),
                "not_translated_title" => "Discount label",
                "popup" => __("Label for discount in payment summary.", "webba-booking-lite"),
                "tab" => "payments",
            ],
        );
        wbk_opt()->add_option(
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                "popup" => __("Label for Pay now in booking form sidebar.", "webba-booking-lite"),
                "tab" => "booking-status",
            ],
        );
        ...
        wbk_opt()->add_option(
            ...
            "wbk_translation_settings_section",
            [
                "default" => __("Please fill out payment form.", "webba-booking-lite"),
